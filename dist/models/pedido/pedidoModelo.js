...
exports.pedidoErp = void 0;
const databaseConfig_1 = require("../../database/databaseConfig");
const pedidoApi_1 = require("../pedidoApi/pedidoApi");
class pedidoErp {
    async cadastraProdutosDoPedido(produtos, codigoPedido) {
        return new Promise(async (resolve, reject) => {
            ...
            for (const prod of produtos) {
                ...
                const sql = `
			INSERT INTO ${databaseConfig_1.db_vendas}.pro_orca (orcamento, sequencia, produto, grade, padronizado, complemento, unidade, item_unid, just_ipi, just_icms, just_subst, quantidade, unitario, tabela, preco_tabela, CUSTO_MEDIO, ULT_CUSTO, FRETE, ipi, desconto)
			VALUES (
				'${codigoPedido}',
				'${i}',
				'${codigoProduto}',
    ...
    async cadastrarPedido(pedido) {
        ...
        const { codigo_site, status, cod_site, cliente, total_produtos, desc_prod, total_geral, data_pedido, valor_frete, situacao, data_cadastro, hora_cadastro, data_inicio, hora_inicio, vendedor, contato, observacoes, observacoes2, tipo, NF_ENT_OS, RECEPTOR, VAL_PROD_MANIP, PERC_PROD_MANIP, PERC_SERV_MANIP, REVISAO_COMPLETA, DESTACAR, TABELA, QTDE_PARCELAS, ALIQ_ISSQN, OUTRAS_DESPESAS, PESO_LIQUIDO, BASE_ICMS_UF_DEST, FORMA_PAGAMENTO, produtos, parcelas } = pedido;
                ...
                if (err) {
                    ...
                    if (resultProdutos) {
                        try {
                            ...
                            console.log("ocorreu um erro ao tentar gravar as parcelas");
                        }
                    }
                }
            });
